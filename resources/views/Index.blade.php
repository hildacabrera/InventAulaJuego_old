...
@section('content')
    <div class="row">
        <div id="white">
            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" style="width: 50%; margin: 0 auto;">
                ...
                <div class="mb-3 mb-sm-0">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="https://www.iudigital.edu.co/CRAI/Paginas/default.aspx" class="card-link">Bases de
                                Datos</a>
                        </div>
                    </div>
                </div>
